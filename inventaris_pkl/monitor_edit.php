		...
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="monitor_update.php">
					...
					<a href="monitor.php" class="btn btn-secondary">kembali</a>
				</form>
			</div>
		</div>
	</div>
