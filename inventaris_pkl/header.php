...
<nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background: #1e88e5">
  <div class="container-fluid">

  	<a class="navbar-brand" href="index.php">
      <img src="assets/logopei.png" alt="Logo pei" style="width:40px;" class="rounded-pill"> 
    </a>
    ...
    <ul class="navbar-nav nav-justified w-100">
      ...
      <li class="nav-item">
        <a href="printer.php" class="nav-link">
