...
<div class="container">
	<div class="card">
		...
		<div class="card-body">
			<form method="post" action="pc_aksi.php">
				...
				<table class="table table-bordered table-striped">
						<tr>
							...
							<td width="75%"><input type="text" name="computer_name" class="form-control"></td>
						</tr>
						<tr>
							<td><h6>Mainboard</h6></td>
							<td width="75%"><input type="text" name="mainboard" class="form-control"></td>
						</tr>
						<tr>
						...
						<tr>
							<td><h6>VGA</h6></td>
							<td width="75%"><input type="text" name="vga" class="form-control"></td>
						</tr>
						<tr>
							<td><h6>HDD</h6></td>
						...
						<tr>
							...
							<td width="75%"><input type="text" name="mac_address" class="form-control"></td>
						</tr>
						<tr>
							<td><h6>no_seri</h6></td>
