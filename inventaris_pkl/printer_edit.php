		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<a href="printer.php" class="btn btn-secondary">kembali</a>
				</form>
			</div>
		</div>
	</div>
