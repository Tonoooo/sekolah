		...
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="scanner_update.php">
					...
					<a href="scanner.php" class="btn btn-secondary">kembali</a>
				</form>
			</div>
		</div>
	</div>
